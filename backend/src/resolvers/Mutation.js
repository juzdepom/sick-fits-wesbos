...
const Mutations = {
    ...
    async resetPassword(parent, args, ctx, info) {
        ...
        const [user] = await ctx.db.query.users({
            where: {
                ...
                //make sure the token is within the one year time limit
    ...
    async addToCart(parent, args, ctx, info) {
        ...
        return ctx.db.mutation.createCartItem(
            ...
            data: {
                user: {
                    // this is the syntax you use to connect a relationship in Prisma
                connect: { id: userId },
                },
                item: {
                connect: { id: args.id },
    ...
    async removeFromCart(parent, args, ctx, info) {
        ...
        //deleteCartItem is generated in prisma.graphql
